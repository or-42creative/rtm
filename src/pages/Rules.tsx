  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="animate-fade-up rounded-3xl bg-gradient-to-l from-[var(--c-purple)] via-[var(--c-pink)] to-[var(--c-orange)] p-8 text-white shadow-lg">
        <p className="text-sm font-black text-white/90">{t("rules.kicker")}</p>
        <h1 className="mt-1 text-4xl font-black">{t("rules.title")}</h1>
        <p className="mt-2 max-w-xl font-medium text-white/90">{t("rules.tagline")}</p>
      </div>
